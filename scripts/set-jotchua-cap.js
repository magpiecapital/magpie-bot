#!/usr/bin/env node
/**
 * One-shot: pin $JOTCHUA per-token cap to 20 SOL.
 *
 * JOTCHUA was hitting the "small" tier default of 10 SOL — explicit
 * override on supported_mints.max_open_lamports replaces the tier
 * calculation entirely. See anti-exploit.js:354-363:
 *
 *   const override = mintRow?.max_open_lamports;
 *   if (override !== null && override !== undefined) {
 *     cap = BigInt(String(override));   // use the override
 *   } else {
 *     cap = computeTokenTier(mintRow).capLamports;  // tier default
 *   }
 *
 * Mirrors scripts/set-worldcup-cap.js. Equivalent to running
 * /set_token_cap BcHEaaTCvycPwwsJ9yQTXdHP9X2gCLkznDbZ8VySpump 20
...
const MINT = "BcHEaaTCvycPwwsJ9yQTXdHP9X2gCLkznDbZ8VySpump";
const CAP_SOL = 20;
